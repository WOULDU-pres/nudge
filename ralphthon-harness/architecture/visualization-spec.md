...
- **Tailwind CSS v4** (HeroUI v3 필수 — v3 아님)
- **Recharts** (차트 라이브러리)
- Vite 빌드
...
5. **import 순서** — globals.css에서 Tailwind → HeroUI 순서 필수
...
node ~/.claude/skills/heroui-react/scripts/get_component_docs.mjs Table Button Tooltip
