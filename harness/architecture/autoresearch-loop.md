...
LOOP FOREVER:
  ...
  1.5. Strategy Ledger 확인
     - cat strategy_ledger.json | python -m json.tool | head -50
     - 이전 세대들의 누적 학습 확인
     - cumulative_insights의 never_repeat 패턴 확인
...
### Ledger 메트릭
- best_score_ever: 전 세대 통틀어 최고 avg_score
- generation_count: 지금까지 실행된 세대 수
- never_repeat 항목 수: 확인된 실패 패턴 수
- proven_effective 항목 수: 확인된 성공 패턴 수
...
| avg_score > best_score_ever (ledger) | keep + milestone 기록 | 역대 최고 달성 |
